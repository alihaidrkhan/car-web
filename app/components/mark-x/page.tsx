...
return(
    ...
    <div>
           ...
           <div className="flex justify-center py-10"><div className="w-1/2 h-24"><h1 className="text-3xl text-center"><u><b> Honda Civic 2024 Price In Pakistan, Images, Reviews & Specs</b></u></h1></div></div>

            <div className="flex justify-center"><Image src={markx} alt="loading" width={400} /></div>
            ...
            <div className="flex justify-center py-12">
                ...
                <div className="flex justify-center py-7"><h1 className="text-green-600 text-2xl">PKR 90.00.000</h1></div>
