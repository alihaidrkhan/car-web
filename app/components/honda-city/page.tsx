...
return(
    ...
    <div>
           ...
           <div className="flex justify-center py-10"><div className="w-1/2 h-24"><h1 className="text-3xl text-center"><u><b> Honda City 2024 Price In Pakistan, Images, Reviews & Specs</b></u></h1></div></div>

            <div className="flex justify-center"><Image src={city} alt="loading" width={400} /></div>
